def minimum_skew(genome): #Tra ve danh sach cac vi tri nho nhat (ori)
    skew_list = [0]
...
file_path = "C:/Users/USER/OneDrive/Pictures/Documents/Homework/1000.Bioinformatics/Coursera/Week2/SalmonellaEnterica.txt"
f = open(file_path, 'r')
